...
export ZSH="/Users/pmital/.oh-my-zsh"
...
alias git-resync="git checkout master && git fetch upstream && git pull --rebase upstream master && git push && git checkout -"
alias git-resync-main="git checkout main && git fetch upstream && git pull --rebase upstream main && git push && git checkout -"
